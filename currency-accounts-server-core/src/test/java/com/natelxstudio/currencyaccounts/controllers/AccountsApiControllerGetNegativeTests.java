...
@IntegrationTest
class AccountsApiControllerGetNegativeTests {
    @LocalServerPort
    private int serverPort;

    @Test
    @SneakyThrows
    void whenUserWantsToGetAccountDetailsAndIdIsNotCorrect_thenReturnBadRequestResponse() {
        Response response = given()
            .port(serverPort)
            .when()
            .contentType(ContentType.JSON)
            .get(GET_ACCOUNTS_DETAILS, "test")
            .then()
    ...
    @Test
    @SneakyThrows
    void whenUserWantsToGetAccountDetailsAndAccountNotExist_thenReturnNotFoundResponse() {
        ...
        Response response = given()
            ...
            .when()
            .contentType(ContentType.JSON)
            .get(GET_ACCOUNTS_DETAILS, accountId)
            .then()
